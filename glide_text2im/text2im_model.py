...
class Text2ImUNet(UNetModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.xf_width:
            ...
            th.nn.init.xavier_uniform_(self.token_embedding.weight)
    ...
    def get_text_emb(self, tokens, mask):
        ...
        xf_in = xf_in + th.nan_to_num(self.positional_embedding[None])
        if self.xf_padding:
            assert mask is not None
            xf_in = th.where(mask[..., None], xf_in, th.nan_to_num(self.padding_embedding[None]))
